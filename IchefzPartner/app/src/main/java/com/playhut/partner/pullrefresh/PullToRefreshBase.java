...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
     ...
     * 回滚的时间
     */
    private static final int SCROLL_DURATION = 220;
    /**
     * 阻尼系数
     */
    private static final float OFFSET_RADIO = 1.75f;
    /**
     * 上一次移动的点
     */
     ...
     * 下拉的状态
     */
    public State mPullDownState = State.NONE;
    /**
     * 上拉的状态
     */
    public State mPullUpState = State.NONE;
    /**
     * 可以下拉刷新的View
     */
    T mRefreshableView;
    ...
    public void setPullRefreshEnabled(boolean pullRefreshEnabled) {
        ...
        setBackgroundColor(getResources().getColor(R.color.refresh_bg_color));
    }
     ...
     */
    protected abstract LoadingLayout createHeaderLoadingLayout(Context context, AttributeSet attrs);
     ...
     * @return LoadingLayout对象
     */
    protected abstract LoadingLayout createFooterLoadingLayout(Context context, AttributeSet attrs);
     ...
     * @param y 滚动y位置
     */
    public void setScrollBy(int x, int y) {
        scrollBy(x, y);
    }
