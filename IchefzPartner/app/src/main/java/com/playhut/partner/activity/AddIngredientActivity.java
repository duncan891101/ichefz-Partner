 ...
 *
 */
public class AddIngredientActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void initTitleBar() {
        ...
        titleBar.setLeftIvClickListener(new PartnerTitleBar.TitleBarClickListener() {
            @Override
            public void onClick() {
                AddIngredientActivity.this.finish();
            }
        });
            ...
            case R.id.rl_add_content:
                mChooseAvatarBusiness.showChooseAvatarDialog(new ChooseAvatarBusiness.UserSelectAvatarListener() {
                    ...
                    public void select(Bitmap bitmap, File file) {
                        AddTipsItemView addTipsItemView = new AddTipsItemView(AddIngredientActivity.this);
    ...
    private void jumpToNext() {
        startActivity(new Intent(this, AddInstructionActivity.class));
        AddIngredientActivity.this.finish();
    }
